   ...
   return (
    <div class="content">
        ...
        <div class="links-container">
            ...
            <p>Website created to explore in depht the Studio Ghibli universe, from recipes inspired from the movies to real-life locations. Made by using HTML and CSS.  </p>
